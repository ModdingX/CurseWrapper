...
public class CacheKey<K, V> {
    ...
    public static final CacheKey<FileKey, FileInfo> FILE = new CacheKey<>(200, 1000 * 60 * 60 * 3);
    public static final CacheKey<FileKey, String> CHANGELOG = new CacheKey<>(200, 1000 * 60 * 60);
